...
public class DummyTaskFactoryImpl implements TaskFactory {
	 ...
	 *
	 */
    public DummyTaskFactoryImpl(final ComplexTaskDefDAO complexTaskDefDAO, final ComplexTaskHandlingDAO complexTaskHandlingDAO,
    ...
    public Tasklet createTasklet(final String userId, final long taskId)
        ...
        final ComplexTasklet tasklet =
                ...
                Tasklet.Status.INITIALIZED, null/* taskletVO.getFlags() */, correction, complexTaskHandlingDAO, bais, new HashMap<String, String>());
    ...
    public TaskDef getTaskDef(final long taskId) {
        ...
        InputStream is;
        is = new BufferedInputStream(new StringBufferInputStream(this.taskdefXml));
        final TaskDef_ComplexImpl cp = new TaskDef_ComplexImpl(taskId, DUMMY_TITLE,
                ...
                is, false/* t.getComplexTaskDef().isShowCorrectionToStudents() */, true/* t.isVisible() */);
     ...
     * (non-Javadoc)
     * 
     * @see de.thorstenberger.taskmodel.TaskFactory#getUserIdsOfAvailableTasklets(long)
     */
     ...
     * (non-Javadoc)
     * 
     * @see de.thorstenberger.taskmodel.TaskFactory#getUserIdsOfTaskletsAssignedToCorrector(long, java.lang.String)
     */
